...
public class LinkedList<E> extends AbstractSequentialList<E> implements
	...
	public void setTimeForLife(long time) {
		timeForLife = time;
	}
	public LinkedList() {
	}
	...
	public E set(int index, E element) {
		checkElementIndex(index);
		Node<E> x = node(index);
		x.timeOfCreation = System.currentTimeMillis();
		E oldVal = x.item;
		x.item = element;
		return oldVal;
	}
	...
	private static class Node<E> {
		...
		boolean isAlive() {
			...
			long timeOfLife =  System.currentTimeMillis() - timeOfCreation;
			
			if(timeOfLife > timeForLife) 
				return false;
			else
				return true;
		}
